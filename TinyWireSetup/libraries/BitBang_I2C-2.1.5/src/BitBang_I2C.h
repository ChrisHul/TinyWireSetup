...
// used for direct port access ( not PIN numbering)
enum {
  EPORTG = 0xa0, 
  EPORTB = 0xb0,
  EPORTC = 0xc0,
...
{
uint8_t iSDA, iSCL; // bit numbers (0xff = disabled)
uint8_t *iDDR_SDA, *iDDR_SCL; 
uint8_t iSDABit, iSCLBit; 
uint8_t *iPort_SDA_In, *iPort_SDA_Out; 
uint8_t *iPort_SCL_In, *iPort_SCL_Out; 
